...
const CourseCard = ({ Title, Content, handleRemoveVideo, removeSection, setSectionContent }) => {
    const [video, setVideo] = useState('');

    const handleCourseAccess = () => {
        setSectionContent({ ...Content, isfree: !Content.isfree })
    }
    const videoDiv = () => {
        return (
    ...
    return (
        <div className={styles.AddSectionDiv}>
            ...
            {removeSection && <div className={styles.removeSection}><DeleteIcon className={styles.DeleteIcon} onClick={() => removeSection()} /></div>}
        </div>
    )
}
